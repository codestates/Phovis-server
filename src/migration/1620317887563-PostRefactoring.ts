...
export class PostRefactoring1620317887563 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `content_card` ADD CONSTRAINT `FK_f08ce43aafa2e30719736c066be` FOREIGN KEY (`contentId`) REFERENCES `content`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
        ...
        await queryRunner.query("ALTER TABLE `imagecard_tag_tag` ADD CONSTRAINT `FK_004cec589a3f84432567ee1396b` FOREIGN KEY (`imagecardId`) REFERENCES `imagecard`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `imagecard_tag_tag` ADD CONSTRAINT `FK_bf694fb3d25d172fbeaa31d15c5` FOREIGN KEY (`tagId`) REFERENCES `tag`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `imagecard_tag_tag` DROP FOREIGN KEY `FK_bf694fb3d25d172fbeaa31d15c5`");
        await queryRunner.query("ALTER TABLE `imagecard_tag_tag` DROP FOREIGN KEY `FK_004cec589a3f84432567ee1396b`");
        ...
        await queryRunner.query("DROP INDEX `IDX_bf694fb3d25d172fbeaa31d15c` ON `imagecard_tag_tag`");
        await queryRunner.query("DROP INDEX `IDX_004cec589a3f84432567ee1396` ON `imagecard_tag_tag`");
        await queryRunner.query("DROP TABLE `imagecard_tag_tag`");
