...
export class PostRefactoring1619704213962 implements MigrationInterface {
    name = 'PostRefactoring1619704213962'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `location` (`id` int NOT NULL AUTO_INCREMENT, `location` varchar(255) NOT NULL, `lat` int NOT NULL, `lng` int NOT NULL, `createdAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB");
